...
install_dnsmasq(){
    ...
    download /tmp/proxy-domains.txt https://raw.githubusercontent.com/sola614/dnsmasq_sniproxy_install/master/proxy-domains.txt
...
install_sniproxy(){
    ...
    download /tmp/sniproxy-domains.txt https://raw.githubusercontent.com/sola614/dnsmasq_sniproxy_install/master/proxy-domains.txt
